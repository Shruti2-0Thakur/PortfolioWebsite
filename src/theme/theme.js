...
export const o1ThemeDark = {
    type: 'dark',
    primary: '#86b6ce',       // Light blue for the primary elements
    primary400: '#78a5bd',    // Slightly darker blue for secondary elements
    primary600: '#6a94ac',    // Even darker blue for accents
    primary80: '#86b6cecc',   // Light blue with opacity for subtle effects
    primary50: '#86b6cedd',   // Light blue with more opacity
    primary30: '#86b6ce80',   // Light blue with significant opacity for backgrounds
    secondary: '#000000',     // Black for accents and highlights
    secondary70: '#1c1c1c',   // Dark gray for secondary elements
    secondary50: '#333333',   // Slightly lighter gray for deeper accents
    tertiary: '#e0e0e0',      // Light gray for text to ensure good contrast
    tertiary80: '#e0e0e0cc',  // Light gray with opacity for subtle text
    tertiary70: '#e0e0e0b3',  // Light gray with more opacity
    tertiary50: '#e0e0e080',
   //ght gray with more opacity for background elements
    aboutimg1: orangeThemeboy,
    aboutimg2: orangeThemegirl,
    eduimg: eduOrange,
    expimg: expOrange,
    contactsimg: contactsOrange  // Path to dark mode image
}
